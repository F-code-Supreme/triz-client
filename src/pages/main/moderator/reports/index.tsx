...
import { reportPostsColumns } from '@/features/report/components/report-posts-columns';
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-muted-foreground mt-2">
              Xem và quản lý tất cả báo cáo bài viết trong diễn đàn tại đây.
            </p>
          </div>
        </div>
