...
import StepBasic from '@/pages/main/admin/courses/create/components/StepBasic';
import StepModules from '@/pages/main/admin/courses/create/components/StepModules';
import StepPlaceholder from '@/pages/main/admin/courses/create/components/StepPlaceholder';
        ...
        <div className="flex items-center justify-between">
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground">
              Chỉnh sửa một khóa học với nhiều chương trình và bài tập.
            </p>
          </div>
        </div>
