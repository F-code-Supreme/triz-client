        ...
        <div className="text-center">
          <div className="space-y-6">
            <div className="relative inline-block">
              <p className="text-4xl lg:text-5xl xl:text-6xl font-bold text-slate-900 dark:text-white leading-tight">
              ...
              <div>
                <p className="text-base sm:text-lg lg:text-xl text-slate-600 dark:text-slate-300 max-w-4xl mx-auto leading-relaxed mt-6">
                  Ôn tập và ghi nhớ các nguyên tắc sáng tạo một cách hiệu quả
                </p>
              </div>
            </div>
          </div>
          ...
          {isPending ? (
            <FallbackLoading isCenter />
          ) : (
            <FlashcardDecks decks={data?.content || []} />
          )}
        </div>
      </div>
    </section>
