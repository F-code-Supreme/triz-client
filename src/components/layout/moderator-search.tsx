...
import { ModeratorCommandMenu } from '@/components/layout/moderator-command-menu';
import { Button } from '@/components/ui/button';
import { cn } from '@/lib/utils';

type ModeratorSearchProps = {
  className?: string;
  placeholder?: string;
};

export const ModeratorSearch = React.forwardRef<
  HTMLButtonElement,
...
>(({ className = '', placeholder = 'Search...' }, ref) => {
  ...
  return (
    <>
      ...
      <ModeratorCommandMenu open={open} onOpenChange={setOpen} />
    </>
  );
});

ModeratorSearch.displayName = 'ModeratorSearch';
