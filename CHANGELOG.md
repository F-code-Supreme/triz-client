...
- Initiate project from https://github.com/lukedaviesdev/BaseJS-2025.
- Setup tanstack react query & router, axios, vercel, shadcn UI, i18next, common hooks.
- Add 404, 401 page.
- Add Header.
- Add sign in (Credentials + Google), sign up, forgot password + authentication/authorization strategy.
